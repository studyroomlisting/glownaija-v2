  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-6">
        ...
        <p className="text-ink-3 text-sm">Sign in to your GlowNaija account</p>
      </div>
      <div className="card card-body">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input name="email" type="email" className="input" placeholder="you@example.com" required autoComplete="email" autoFocus />
          </div>
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="label mb-0">Password</label>
              <Link href="/auth/forgot-password" className="text-xs text-rose font-semibold hover:underline">Forgot?</Link>
            </div>
            <div className="relative">
              <input name="password" type={showPwd ? 'text' : 'password'} className="input pr-12" placeholder="Your password" required autoComplete="current-password" />
